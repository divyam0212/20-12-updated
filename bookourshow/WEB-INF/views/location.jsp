	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="loc"><span class="glyphicon glyphicon-book"></span>BOOK</a></li>
				<li><a href=""><span class="glyphicon glyphicon-search"></span>SEARCH</a></li>
				<li><a href="#myModal" data-toggle="modal"
					data-target="#myModal"><span class="glyphicon glyphicon-user"></span>SIGN
						UP</a></li>
						...
						<p>
							<form name="location" method="post" action="LocationController">
								<div class="form-group">
							      ...
							      <select class="form-control input-lg" id="sel2" name="address">
							    ...
							    <div class="form-group">
										<input class="form-control input-md "
																style="color: white; background-color: #C3222A" value="EXPLORE"
																name="submit" id="inputlg" type="submit">
								</div>
							</form>
						</p>
