	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" >
					<div class="main" align="center">
						<button class="tabs" rel="content2" id="login">Log In</button>
						<button class="tabs active" id="signup" rel="content1">SignUp</button>
			...
			<div class="modal-footer">
				<a href="login" class="link">Are you looking for HackerRank for
					Work?</a>
			</div>
