	...
	<form name="moviedetail" action="DispVenue" method="post">
		...
		<form name="moviedetail" action="DispVenue" method="post">
			...
			<div class="form-group">
				<input class="form-control input-lg" id="inputlg" type="date"
					name="bookDate">
			</div>

			<div class="form-group">
				<label for="sel2">Select Language</label> <select name="languageId">
			...
			<div class="form-group">
				<input class="form-control input-md "
					style="color: white; background-color: #C3222A" value="BOOK SEATS"
